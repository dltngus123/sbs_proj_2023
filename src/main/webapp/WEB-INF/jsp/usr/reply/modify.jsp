...
<section class="mt-5">
	<div class="container mx-auto px-3">
	    <form method="POST" action="../reply/doModify" onsubmit="ReplyModify__submit">
			      ...
			      <colgroup>
			        ...
			        <tbody>
			          ...
			          <tr>
			            <th>댓글 추천수</th>
			            <td>
			            	<span class="btext-blue-700">${reply.goodReactionPoint}</span>
						</td>
			          </tr>
			          <tr>
			            <th>내용</th>
			           ...
			           <tr>
			            <th>댓글 수정</th>
			            <td>
			              <input class="btn btn-primary" type="submit" value="댓글 수정"/>
