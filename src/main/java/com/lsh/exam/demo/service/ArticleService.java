...
public ResultData increaseGoodReactionPoint(int relId) {
	...
	return ResultData.from("S-1", "좋아요 수가 증가 되었습니다.", "affectedRowsCount", affectedRowsCount);
...
public ResultData increaseBadReactionPoint(int relId) {
	...
	return ResultData.from("S-1", "싫어요 수가 증가 되었습니다.", "affectedRowsCount", affectedRowsCount);
